...
This skill provides tools and workflows for managing Mission Control via API calls. It supports health checks, diagnostics, updates, backups, and agent management.
